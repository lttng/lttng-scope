...
public interface CtfConstants {
     ...
     */
    QualifiedName LIVE_HOST = new QualifiedName("org.eclipse.linuxtools.ctf.tmf.core", "live.host"); //$NON-NLS-1$//$NON-NLS-2$

    /**
     * The port persistent property for the live session.
     */
    QualifiedName LIVE_PORT = new QualifiedName("org.eclipse.linuxtools.ctf.tmf.core", "live.port"); //$NON-NLS-1$//$NON-NLS-2$

    /**
     * The live session name persistent property.
     */
    QualifiedName LIVE_SESSION_NAME = new QualifiedName("org.eclipse.linuxtools.ctf.tmf.core", "live.session.name"); //$NON-NLS-1$//$NON-NLS-2$;
}
