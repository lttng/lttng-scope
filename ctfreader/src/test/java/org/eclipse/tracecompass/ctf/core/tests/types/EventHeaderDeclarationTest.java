...
public class EventHeaderDeclarationTest {
     ...
     */
    @Test
    void testCompactCompact() throws CTFException {
     ...
     */
    @Test
    void testCompactExtended() throws CTFException {
        ByteBuffer buffer = ByteBuffer.allocate(16);
     ...
     */
    @Test
    void testLargeCompact() throws CTFException {
        ByteBuffer buffer = ByteBuffer.allocate(16);
     ...
     */
    @Test
    void testLargeExtended() throws CTFException {
        ByteBuffer buffer = ByteBuffer.allocate(16);
