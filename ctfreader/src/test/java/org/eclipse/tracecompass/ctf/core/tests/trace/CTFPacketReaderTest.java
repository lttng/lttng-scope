...
class CTFPacketReaderTest {
     ...
     */
    @Test
    void testPacket() throws CTFException {
     ...
     */
    @Test
    void testPacketWithContext() throws CTFException {
        // step 1: create in memory CTF trace
        byte[] bytes = { (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x01, (byte) 0xff, (byte) 0xff, (byte) 0xa5 };
        BitBuffer input = createBitBuffer(bytes);
        // step 2, create the packet context
     ...
     */
    @Test
    void testPacketNoHeader() throws CTFException {
        // step 1: create in memory CTF trace
        byte[] bytes = { (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x01, (byte) 0xff, (byte) 0xff, (byte) 0xa5 };
        BitBuffer input = createBitBuffer(bytes);
        // step 2, create the packet context
     ...
     */
    @Test
    void testPacketWithPacketContextAndLostEvents() throws CTFException {
        // step 1: create in memory CTF trace
