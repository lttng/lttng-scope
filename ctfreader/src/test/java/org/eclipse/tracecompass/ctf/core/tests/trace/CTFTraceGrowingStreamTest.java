 ...
 *
 */
class CTFTraceGrowingStreamTest {
     ...
     */
    @BeforeEach
    void init() throws IOException, CTFException {
     ...
     */
    @Test
    void testGrowingLive() throws CTFException, FileNotFoundException, IOException {
     ...
     */
    @Test
    void testGrowingNotLive() throws CTFException, FileNotFoundException, IOException {
        try (CTFTraceReader reader = new CTFTraceReader(fFixture);) {
