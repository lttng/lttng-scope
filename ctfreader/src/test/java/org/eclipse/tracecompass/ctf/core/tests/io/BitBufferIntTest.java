...
class BitBufferIntTest {
     ...
     */
    @Test
    void testGetInt_base() throws CTFException {
     ...
     */
    @Test
    void testGetInt_pos0() throws CTFException {
        fixture.position(0);
        int result = fixture.getInt();
     ...
     */
    @Test
    void testGetInt_pos1() throws CTFException {
        fixture.position(1);
     ...
     */
    @Test
    void testGetInt_pos2() throws CTFException {
        fixture.position(2);
     ...
     */
    @Test
    void testGetInt_le2() throws CTFException {
     ...
     */
    @Test
    void testGetInt_le1() throws CTFException {
        BitBuffer leFixture = createBuffer(128);
        leFixture.setByteOrder(ByteOrder.LITTLE_ENDIAN);
     ...
     */
    @Test
    void testGetInt_invalid() throws CTFException {
        ...
        assertThrows(CTFException.class, () -> smallFixture.get(32, true));
    }
     ...
     */
    @Test
    void testGetInt_invalid2() throws CTFException {
        BitBuffer smallFixture = createBuffer(2);
        smallFixture.setByteOrder(ByteOrder.BIG_ENDIAN);
        ...
        /* This will attempt to read past the buffer's end. */
        assertThrows(CTFException.class, () -> smallFixture.get(64, true));
    }
     ...
     */
    @Test
    void testGetLong_pos0() throws CTFException {
        fixture.position(0);
     ...
     */
    @Test
    void testGetLong_pos7() throws CTFException {
        fixture.position(7);
        long result = fixture.getLong();
     ...
     */
    @Test
    void testGetLong_pos8() throws CTFException {
        fixture.position(8);
        long result = fixture.getLong();
     ...
     */
    @Test
    void testGetLong_pos0LE() throws CTFException {
        fixture.position(0);
     ...
     */
    @Test
    void testGetLong_pos7LE() throws CTFException {
        fixture.position(7);
        fixture.setByteOrder(ByteOrder.LITTLE_ENDIAN);
        long result = fixture.getLong();
     ...
     */
    @Test
    void testGetLong_pos8LE() throws CTFException {
        fixture.position(8);
        fixture.setByteOrder(ByteOrder.LITTLE_ENDIAN);
        long result = fixture.getLong();
     ...
     */
    @Test
    void testGet35_pos0BE() throws CTFException {
        fixture.position(0);
     ...
     */
    @Test
    void testGet35_pos8BE() throws CTFException {
        fixture.position(8);
        long result = fixture.get(35, false);
     ...
     */
    @Test
    void testGet35_pos0LE() throws CTFException {
        fixture.position(0);
        fixture.setByteOrder(ByteOrder.LITTLE_ENDIAN);
        long result = fixture.get(35, false);
     ...
     */
    @Test
    void testGetLong35_pos7LE() throws CTFException {
        fixture.position(7);
        fixture.setByteOrder(ByteOrder.LITTLE_ENDIAN);
        long result = fixture.get(35, false);
     ...
     */
    @Test
    void testGetLong35_pos8LE() throws CTFException {
        fixture.position(8);
        fixture.setByteOrder(ByteOrder.LITTLE_ENDIAN);
        long result = fixture.get(35, false);
     ...
     */
    @Test
    void testGetLong35s_pos0LE() throws CTFException {
        fixture.position(0);
        fixture.setByteOrder(ByteOrder.LITTLE_ENDIAN);
     ...
     */
    @Test
    void testGetLong35s_pos7LE() throws CTFException {
        fixture.position(7);
        fixture.setByteOrder(ByteOrder.LITTLE_ENDIAN);
        long result = fixture.get(35, true);
        assertEquals(0x0208060402L, result);
     ...
     */
    @Test
    void testGetLong35s_pos8LE() throws CTFException {
        fixture.position(8);
        fixture.setByteOrder(ByteOrder.LITTLE_ENDIAN);
        long result = fixture.get(35, true);
     ...
     */
    @Test
    void testGetSigned() throws CTFException {
        fixture.position(0);
        fixture.putInt(-1);
        fixture.putInt(-1);
        fixture.position(0);
     ...
     */
    @Test
    void testGetUnsigned() throws CTFException {
        fixture.position(0);
        fixture.putInt(-1);
        fixture.putInt(-1);
        fixture.position(0);
     ...
     */
    @Test
    void testGet24Signed() throws CTFException {
        fixture.position(0);
        fixture.putInt(-1);
        fixture.putInt(-1);
        fixture.position(0);
     ...
     */
    @Test
    void testGet24Unsigned() throws CTFException {
        fixture.position(0);
        fixture.putInt(-1);
        fixture.putInt(-1);
        fixture.position(0);
     ...
     */
    @Test
    void testPutInt() throws CTFException {
        fixture.position(1);
        fixture.putInt(1);
    }
     ...
     */
    @Test
    void testPutInt_length1() throws CTFException {
        fixture.position(1);
        fixture.putInt(1, 1);
    }
     ...
     */
    @Test
    void testPutInt_length0() throws CTFException {
        fixture.position(1);
        fixture.putInt(0, 1);
    }
     ...
     */
    @Test
    void testPutIntLe() throws CTFException {
        fixture.setByteOrder(ByteOrder.LITTLE_ENDIAN);
        fixture.position(1);
        fixture.putInt(1);
    }
     ...
     */
    @Test
    void testPutIntLe_length1() throws CTFException {
        fixture.setByteOrder(ByteOrder.LITTLE_ENDIAN);
        fixture.position(1);
        fixture.putInt(1, 1);
    }
     ...
     */
    @Test
    void testPutIntLe_length0() throws CTFException {
        fixture.setByteOrder(ByteOrder.LITTLE_ENDIAN);
        fixture.position(1);
        fixture.putInt(0, 1);
    }
     ...
     */
    @Test
    void testPutInt_hex() throws CTFException {
     ...
     */
    @Test
    void testPutInt_invalid() throws CTFException {
        BitBuffer fixture2;
        ...
        assertThrows(CTFException.class, () -> fixture2.putInt(32, 1));
    }
}
