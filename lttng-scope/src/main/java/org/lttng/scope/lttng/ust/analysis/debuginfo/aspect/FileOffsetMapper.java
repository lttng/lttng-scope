...
//     */
//    private static final LoadingCache<FileOffset, Iterable<Addr2lineInfo>> ADDR2LINE_INFO_CACHE;
//    static {
//        ADDR2LINE_INFO_CACHE = requireNonNull(CacheBuilder.newBuilder()
//            .maximumSize(CACHE_SIZE)
//            .build(new CacheLoader<FileOffset, Iterable<Addr2lineInfo>>() {
//                @Override
//                public Iterable<Addr2lineInfo> load(FileOffset fo) {
