...
package org.lttng.scope.lttng.kernel.ui.views.resources.internal;
...
public class AggregateEventIterator implements Iterator<@NonNull ITimeEvent> {
    ...
    private final List<org.lttng.scope.lttng.kernel.ui.views.resources.internal.CachingIterator> fIterators = new ArrayList<>();
    ...
    public @NonNull ITimeEvent next() {
        ...
        final List<org.lttng.scope.lttng.kernel.ui.views.resources.internal.CachingIterator> iterators = fIterators;
