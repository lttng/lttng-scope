...
public class AggregateEventIterator implements Iterator<@NonNull ITimeEvent> {
    ...
    private final List<org.eclipse.tracecompass.analysis.os.linux.ui.views.resources.internal.CachingIterator> fIterators = new ArrayList<>();
    ...
    public @NonNull ITimeEvent next() {
        ...
        final List<org.eclipse.tracecompass.analysis.os.linux.ui.views.resources.internal.CachingIterator> iterators = fIterators;
